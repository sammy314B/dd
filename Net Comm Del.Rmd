...
clustered <- cluster_walktrap(node_deletion_of_keyplayers) # !MANUAL replace cluster_walktrap(igraphobject) with cluster_infomap(igraphobject) if graph is directed.
...
# Determine remaining communities to calculate modularity
clustered <- cluster_walktrap(node_deletion_of_highdegree) # !MANUAL replace cluster_walktrap(igraphobject) with cluster_infomap(igraphobject) if graph is directed.
